...
import { gerarNotificacoesConsultasPendentes } from "../gerar-consultas/utils";
...
export async function POST() {
  ...
  try {
    ...
    const resultados = await gerarNotificacoesConsultasPendentes(
      connection,
    ...
    console.error("Erro ao gerar notificações pendentes:", error);
    return Response.json(
