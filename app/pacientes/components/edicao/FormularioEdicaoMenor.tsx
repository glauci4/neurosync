...
export default function FormularioEdicaoMenor({ paciente, onSubmit, isPending }: Props) {
    ...
    const [responsavel, setResponsavel] = useState({
        ...
        mesmo_endereco_paciente: paciente.responsavel?.mesmo_endereco_paciente ?? true,
    ...
    const validarCpfDuplicado = (): boolean => {
        ...
        if (cpfPaciente && cpfResponsavel && cpfPaciente === cpfResponsavel) {
            setErrosResponsavel(prev => ({ ...prev, cpf: 'CPF do responsável não pode ser igual ao CPF do paciente' }));
            return false;
        }
        return true;
    };
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!pacienteValido || !responsavelValido || !idadeValida || !cpfOk || !contatoValido) return;
