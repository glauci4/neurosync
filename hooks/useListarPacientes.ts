...
interface ListarPacientesParams {
  ...
  somente_responsavel?: boolean; // Lista apenas pacientes com psicólogo responsável igual ao usuário
}
...
async function buscarPacientes(
  ...
  if (params.somente_responsavel) {
    urlParams.set("somente_responsavel", "true");
  }
