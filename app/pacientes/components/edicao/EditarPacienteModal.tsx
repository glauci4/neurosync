...
export default function EditarPacienteModal({ isOpen, onClose, pacienteId, onSuccess }: EditarPacienteModalProps) {
    ...
    const idValido = typeof pacienteId === 'number' && !isNaN(pacienteId) && pacienteId > 0 ? pacienteId : null;
    ...
    return (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                {!idValido && <div className="text-red-500 text-center py-4">ID do paciente inválido, tente novamente.</div>}
                {isLoading && (
